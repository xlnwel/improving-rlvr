...
wandb login e08954d4e7ab0c1bb7e0a7360d18263c1c68b519

math_train_path=./data/math/train.parquet
math_test_path=./data/math/test.parquet
aime24_test_path=./data/aime2024/test.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.low_threshold=0.01 \
    ...
    trainer.experiment_name='qwen3_8b-thred-0.01' \
